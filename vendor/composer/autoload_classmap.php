...
return array(
    ...
    'Inventory\\Application' => $baseDir . '/src/Application.php',
    'Inventory\\Core\\BaseBaO' => $baseDir . '/src/Core/BaseBaO.php',
    'Inventory\\Core\\Containers\\Service' => $baseDir . '/src/Core/Containers/Service.php',
    'Inventory\\Core\\Containers\\Template' => $baseDir . '/src/Core/Containers/Template.php',
    'Inventory\\Core\\Controller\\BaseController' => $baseDir . '/src/Core/Controller/BaseController.php',
    'Inventory\\Core\\Controller\\Form' => $baseDir . '/src/Core/Controller/Form.php',
    'Inventory\\Core\\Controller\\Page' => $baseDir . '/src/Core/Controller/Page.php',
    ...
    'Inventory\\Core\\Exception\\AuthorizationException' => $baseDir . '/src/Core/Exception/AuthorizationException.php',
    'Inventory\\Core\\Exception\\BadArgument' => $baseDir . '/src/Core/Exception/BadArgument.php',
    'Inventory\\Core\\Exception\\BaseException' => $baseDir . '/src/Core/Exception/BaseException.php',
    'Inventory\\Core\\Exception\\ExceptionHandler' => $baseDir . '/src/Core/Exception/ExceptionHandler.php',
    ...
    'Inventory\\Core\\Exception\\InvalidRequest' => $baseDir . '/src/Core/Exception/InvalidRequest.php',
    'Inventory\\Core\\Exception\\RenderingError' => $baseDir . '/src/Core/Exception/RenderingError.php',
    'Inventory\\Core\\Exception\\SQLException' => $baseDir . '/src/Core/Exception/SQLException.php',
    'Inventory\\Core\\Factory' => $baseDir . '/src/Core/Factory.php',
    'Inventory\\Core\\IComponent' => $baseDir . '/src/Core/IComponent.php',
    'Inventory\\Core\\Renderer' => $baseDir . '/src/Core/Renderer.php',
    'Inventory\\Core\\Routing\\Request' => $baseDir . '/src/Core/Routing/Request.php',
    'Inventory\\Core\\Routing\\Router' => $baseDir . '/src/Core/Routing/Router.php',
    'Inventory\\Core\\Routing\\Security' => $baseDir . '/src/Core/Routing/Security.php',
    'Inventory\\Core\\Routing\\SessionManager' => $baseDir . '/src/Core/Routing/SessionManager.php',
    'Inventory\\Core\\Settings' => $baseDir . '/src/Core/Settings.php',
    'Inventory\\Core\\Utils' => $baseDir . '/src/Core/Utils.php',
    'Inventory\\Entity\\Batch\\BAO\\Batch' => $baseDir . '/src/Entity/Batch/BAO/Batch.php',
    'Inventory\\Entity\\Batch\\DAO\\Batch' => $baseDir . '/src/Entity/Batch/DAO/Batch.php',
    'Inventory\\Entity\\Category\\BAO\\Category' => $baseDir . '/src/Entity/Category/BAO/Category.php',
    'Inventory\\Entity\\Category\\DAO\\Category' => $baseDir . '/src/Entity/Category/DAO/Category.php',
    'Inventory\\Entity\\Compound\\BAO\\Compound' => $baseDir . '/src/Entity/Compound/BAO/Compound.php',
    'Inventory\\Entity\\Compound\\DAO\\Compound' => $baseDir . '/src/Entity/Compound/DAO/Compound.php',
    'Inventory\\Entity\\Laboratory\\DAO\\Laboratory' => $baseDir . '/src/Entity/Laboratory/DAO/Laboratory.php',
    'Inventory\\Entity\\Location\\DAO\\Location' => $baseDir . '/src/Entity/Location/DAO/Location.php',
    'Inventory\\Entity\\Manufacturer\\DAO\\Manufacturer' => $baseDir . '/src/Entity/Manufacturer/DAO/Manufacturer.php',
    'Inventory\\Entity\\Pack\\DAO\\Pack' => $baseDir . '/src/Entity/Pack/DAO/Pack.php',
    'Inventory\\Entity\\Place\\DAO\\Place' => $baseDir . '/src/Entity/Place/DAO/Place.php',
    'Inventory\\Entity\\SubCategory\\BAO\\SubCategory' => $baseDir . '/src/Entity/SubCategory/BAO/SubCategory.php',
    'Inventory\\Entity\\SubCategory\\DAO\\SubCategory' => $baseDir . '/src/Entity/SubCategory/DAO/SubCategory.php',
    'Inventory\\Entity\\Sub\\DAO\\Sub' => $baseDir . '/src/Entity/Sub/DAO/Sub.php',
    'Inventory\\Entity\\User\\BAO\\User' => $baseDir . '/src/Entity/User/BAO/User.php',
    'Inventory\\Entity\\User\\DAO\\User' => $baseDir . '/src/Entity/User/DAO/User.php',
    'Inventory\\Form\\Compound' => $baseDir . '/src/Form/Compound.php',
    'Inventory\\Form\\Login' => $baseDir . '/src/Form/Login.php',
    'Inventory\\Form\\Logout' => $baseDir . '/src/Form/Logout.php',
    'Inventory\\Page\\Batch' => $baseDir . '/src/Page/Batch.php',
    'Inventory\\Page\\Categories' => $baseDir . '/src/Page/Categories.php',
    'Inventory\\Page\\Forms' => $baseDir . '/src/Page/Forms.php',
    'Inventory\\Page\\Index' => $baseDir . '/src/Page/Index.php',
    'Inventory\\Page\\Login' => $baseDir . '/src/Page/Login.php',
    'Inventory\\Page\\SubCategories' => $baseDir . '/src/Page/SubCategories.php',
    'Inventory\\Test\\Framework\\BaseTestCase' => $baseDir . '/tests/Framework/BaseTestCase.php',
    'Inventory\\Test\\Framework\\HeadlessDataBaseTrait' => $baseDir . '/tests/Framework/HeadlessDataBaseTrait.php',
    'Inventory\\Test\\Framework\\IntegrationTestCase' => $baseDir . '/tests/Framework/IntegrationTestCase.php',
    'Inventory\\Test\\Integration\\DataBaseTest' => $baseDir . '/tests/integration/DataBaseTest.php',
    'Inventory\\Test\\Integration\\Form\\LoginTest' => $baseDir . '/tests/integration/Form/LoginTest.php',
    'Inventory\\Test\\Integration\\FrontendTest' => $baseDir . '/tests/integration/FrontendTest.php',
    'Inventory\\Test\\Integration\\RoutingTest' => $baseDir . '/tests/integration/RoutingTest.php',
    'Inventory\\Test\\Integration\\ServicesTest' => $baseDir . '/tests/integration/ServicesTest.php',
    'Inventory\\Test\\Unit\\Core\\Containers\\ServiceTest' => $baseDir . '/tests/unit/Core/Containers/ServiceTest.php',
    'Inventory\\Test\\Unit\\Core\\Containers\\TemplateTest' => $baseDir . '/tests/unit/Core/Containers/TemplateTest.php',
    'Inventory\\Test\\Unit\\Core\\Controller\\ControllerTest' => $baseDir . '/tests/unit/Core/Controller/ControllerTest.php',
    'Inventory\\Test\\Unit\\Core\\DataBase\\SQLDaOTest' => $baseDir . '/tests/unit/Core/DataBase/SQLDaOTest.php',
    'Inventory\\Test\\Unit\\Core\\DataBase\\SQLDataBaseTest' => $baseDir . '/tests/unit/Core/DataBase/SQLDataBaseTest.php',
    'Inventory\\Test\\Unit\\Core\\Exception\\ExceptionHandlerTest' => $baseDir . '/tests/unit/Core/Exception/ExceptionHandlerTest.php',
    'Inventory\\Test\\Unit\\Core\\Exception\\ExceptionTest' => $baseDir . '/tests/unit/Core/Exception/ExceptionTest.php',
    'Inventory\\Test\\Unit\\Core\\FactoryTest' => $baseDir . '/tests/unit/Core/FactoryTest.php',
    'Inventory\\Test\\Unit\\Core\\RendererTest' => $baseDir . '/tests/unit/Core/RendererTest.php',
    'Inventory\\Test\\Unit\\Core\\Routing\\RequestTest' => $baseDir . '/tests/unit/Core/Routing/RequestTest.php',
    'Inventory\\Test\\Unit\\Core\\Routing\\RouterTest' => $baseDir . '/tests/unit/Core/Routing/RouterTest.php',
    'Inventory\\Test\\Unit\\Core\\Routing\\SecurityTest' => $baseDir . '/tests/unit/Core/Routing/SecurityTest.php',
    'Inventory\\Test\\Unit\\Core\\SettingsTest' => $baseDir . '/tests/unit/Core/SettingsTest.php',
    'Inventory\\Test\\Unit\\Core\\UtilsTest' => $baseDir . '/tests/unit/Core/UtilsTest.php',
    'Inventory\\Test\\Unit\\Entity\\EntityDaOTest' => $baseDir . '/tests/unit/Entity/EntityDaOTest.php',
