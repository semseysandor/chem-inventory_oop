...
return array(
    ...
    'Inventory\\Core\\BaseBaO' => $baseDir . '/source/Core/BaseBaO.php',
    'Inventory\\Core\\Containers\\Service' => $baseDir . '/source/Core/Containers/Service.php',
    'Inventory\\Core\\Containers\\Template' => $baseDir . '/source/Core/Containers/Template.php',
    'Inventory\\Core\\Controller\\BaseController' => $baseDir . '/source/Core/Controller/BaseController.php',
    'Inventory\\Core\\Controller\\Form' => $baseDir . '/source/Core/Controller/Form.php',
    'Inventory\\Core\\Controller\\Page' => $baseDir . '/source/Core/Controller/Page.php',
    ...
    'Inventory\\Core\\Exception\\AuthorizationException' => $baseDir . '/source/Core/Exception/AuthorizationException.php',
    'Inventory\\Core\\Exception\\BadArgument' => $baseDir . '/source/Core/Exception/BadArgument.php',
    'Inventory\\Core\\Exception\\BaseException' => $baseDir . '/source/Core/Exception/BaseException.php',
    'Inventory\\Core\\Exception\\ExceptionHandler' => $baseDir . '/source/Core/Exception/ExceptionHandler.php',
    ...
    'Inventory\\Core\\Exception\\InvalidRequest' => $baseDir . '/source/Core/Exception/InvalidRequest.php',
    'Inventory\\Core\\Exception\\RenderingError' => $baseDir . '/source/Core/Exception/RenderingError.php',
    'Inventory\\Core\\Exception\\SQLException' => $baseDir . '/source/Core/Exception/SQLException.php',
    'Inventory\\Core\\Factory' => $baseDir . '/source/Core/Factory.php',
    'Inventory\\Core\\IComponent' => $baseDir . '/source/Core/IComponent.php',
    'Inventory\\Core\\Renderer' => $baseDir . '/source/Core/Renderer.php',
    'Inventory\\Core\\Routing\\Request' => $baseDir . '/source/Core/Routing/Request.php',
    'Inventory\\Core\\Routing\\Router' => $baseDir . '/source/Core/Routing/Router.php',
    'Inventory\\Core\\Routing\\Security' => $baseDir . '/source/Core/Routing/Security.php',
    'Inventory\\Core\\Routing\\SessionManager' => $baseDir . '/source/Core/Routing/SessionManager.php',
    'Inventory\\Core\\Settings' => $baseDir . '/source/Core/Settings.php',
    'Inventory\\Core\\Utils' => $baseDir . '/source/Core/Utils.php',
    'Inventory\\Entity\\Batch\\BAO\\Batch' => $baseDir . '/source/Entity/Batch/BAO/Batch.php',
    'Inventory\\Entity\\Batch\\DAO\\Batch' => $baseDir . '/source/Entity/Batch/DAO/Batch.php',
    'Inventory\\Entity\\Category\\BAO\\Category' => $baseDir . '/source/Entity/Category/BAO/Category.php',
    'Inventory\\Entity\\Category\\DAO\\Category' => $baseDir . '/source/Entity/Category/DAO/Category.php',
    'Inventory\\Entity\\Compound\\BAO\\Compound' => $baseDir . '/source/Entity/Compound/BAO/Compound.php',
    'Inventory\\Entity\\Compound\\DAO\\Compound' => $baseDir . '/source/Entity/Compound/DAO/Compound.php',
    'Inventory\\Entity\\Laboratory\\DAO\\Laboratory' => $baseDir . '/source/Entity/Laboratory/DAO/Laboratory.php',
    'Inventory\\Entity\\Location\\DAO\\Location' => $baseDir . '/source/Entity/Location/DAO/Location.php',
    'Inventory\\Entity\\Manufacturer\\DAO\\Manufacturer' => $baseDir . '/source/Entity/Manufacturer/DAO/Manufacturer.php',
    'Inventory\\Entity\\Pack\\DAO\\Pack' => $baseDir . '/source/Entity/Pack/DAO/Pack.php',
    'Inventory\\Entity\\Place\\DAO\\Place' => $baseDir . '/source/Entity/Place/DAO/Place.php',
    'Inventory\\Entity\\SubCategory\\BAO\\SubCategory' => $baseDir . '/source/Entity/SubCategory/BAO/SubCategory.php',
    'Inventory\\Entity\\SubCategory\\DAO\\SubCategory' => $baseDir . '/source/Entity/SubCategory/DAO/SubCategory.php',
    'Inventory\\Entity\\Sub\\DAO\\Sub' => $baseDir . '/source/Entity/Sub/DAO/Sub.php',
    'Inventory\\Entity\\User\\BAO\\User' => $baseDir . '/source/Entity/User/BAO/User.php',
    'Inventory\\Entity\\User\\DAO\\User' => $baseDir . '/source/Entity/User/DAO/User.php',
    'Inventory\\Form\\Compound' => $baseDir . '/source/Form/Compound.php',
    'Inventory\\Form\\Login' => $baseDir . '/source/Form/Login.php',
    'Inventory\\Form\\Logout' => $baseDir . '/source/Form/Logout.php',
    'Inventory\\Page\\Batch' => $baseDir . '/source/Page/Batch.php',
    'Inventory\\Page\\Categories' => $baseDir . '/source/Page/Categories.php',
    'Inventory\\Page\\Forms' => $baseDir . '/source/Page/Forms.php',
    'Inventory\\Page\\Index' => $baseDir . '/source/Page/Index.php',
    'Inventory\\Page\\Login' => $baseDir . '/source/Page/Login.php',
    'Inventory\\Page\\SubCategories' => $baseDir . '/source/Page/SubCategories.php',
