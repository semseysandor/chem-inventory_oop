...
{block form_content}
    <div class="block">
        <h3 class="float-left">Add Compound</h3>
        <span class="float-right">{include #button_cancel# id="add-compound-cancel"}</span>
        <span class="float-right">{include #button_submit# id="add-compound-submit" title="Add"}</span>
    </div>
    <div class="block">
